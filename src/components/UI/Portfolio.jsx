...
const Portfolio = () =>
{
    ...
    return(
        <section id="portfolio">
            <div className='container'>
                <div className='flex items-center justify-between flex-wrap'>
                    ...
                    <div className='flex gap-3'>
                        ...
                        <button onClick={()=>setSelectTab('web-design')} className='text-smallTextColor border border-solid border-smallTextColor py-2 px-4 rounded-[8px]'> Web Development</button>
                        <button onClick={()=>setSelectTab('ux-design')} className='text-smallTextColor border border-solid border-smallTextColor py-2 px-4 rounded-[8px]'> Data Analysis</button>
            ...
            {showModel && <Modal setShowModel={setShowModel} activeID={activeID}/>}
        </section>
    );
};
